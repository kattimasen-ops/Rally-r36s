...
//#endif
    ...
    if (showmap)
    {
        ...
        glViewport(getWidth() - (getHeight()/3.5f + getWidth() * (2.5f/100.f)), getHeight() * (2.5f/100.f), getHeight()/3.5f, getHeight()/3.5f);
    ...
    if (showui)
    {
        ...
        */
        ...
        // show Next/Total checkpoints
        {
            ...
            glScalef(0.65f, 0.65f, 1.0f);
            getSSRender().drawText("CHECKPOINT", PTEXT_HZA_RIGHT | PTEXT_VTA_TOP);
...
void MainApp::renderDamageIndicatorGroup()
{
    ...
    renderDamageIndicator(
        ...
        tex_damage_front_left, -hratio * 36.0f/50.0f + 0.025f, -vratio * 32.5f/50.0f + 0.032f, 0.025f, 0.032f,
    ...
    renderDamageIndicator(
        ...
        tex_damage_front_right, -hratio * 36.0f/50.0f + 0.075f, -vratio * 32.5f/50.0f + 0.032f, 0.025f, 0.032f,
    ...
    renderDamageIndicator(
        ...
        tex_damage_rear_left, -hratio * 36.0f/50.0f + 0.025f, -vratio * 32.5f/50.0f - 0.032f, 0.025f, 0.032f,
    ...
    renderDamageIndicator(
        ...
        tex_damage_rear_right, -hratio * 36.0f/50.0f + 0.075f, -vratio * 32.5f/50.0f - 0.032f, 0.025f, 0.032f,
