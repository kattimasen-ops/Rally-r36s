...
const char * LIB_PATH_VALUE   = "G:\\home\\eugene\\trigger-rally-code-r1019\\src\\build\\jpeg-9c\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "G:\\home\\eugene\\trigger-rally-code-r1019\\src\\build\\jpeg-9c\\.libs;G:\\home\\eugene\\trigger-win64-root\\lib;G:\\home\\eugene\\trigger-win64-root\\bin;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"jpegtran.exe:jpegtran:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1", f);
  fputs (">&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("    PATH=/home/eugene/trigger-rally-code-r1019/src/build/jpeg-9c/.libs:/home/eu", f);
  fputs ("gene/trigger-win64-root/lib:/home/eugene/trigger-win64-root/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/home/eugene/trigger-rally-code-r1019/src/build/jpeg-9c/.libs:$PATH\"\n", f);
  fputs ("\n", f);
